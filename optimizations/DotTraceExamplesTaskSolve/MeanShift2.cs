...
{
	public static class ImageProcessingAlgorithms5
	{
		...
		private static readonly Lazy<LUV[]> cachedLUVSpace = new Lazy<LUV[]>(() => new LUV[rgbChannelLength * rgbChannelLength * rgbChannelLength]);
		private static readonly Lazy<RGB[]> cachedRGBSpace = new Lazy<RGB[]>(() => new RGB[chanelLLength * chanelULength * chanelVLength]);
